...
namespace TravelPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20241203140522_trails2")]
    partial class trails2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttractionTrail", b =>
                {
                    b.Property<int>("AttractionsId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("AttractionsId", "TrailsId");

                    b.HasIndex("TrailsId");

                    b.ToTable("AttractionTrail");
                });
            ...
            modelBuilder.Entity("AttractionTrail", b =>
                {
                    ...
                    b.HasOne("TravelPlanner.Domain.Models.Trails.Trail", null)
                        .WithMany()
