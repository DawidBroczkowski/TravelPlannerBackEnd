...
namespace TravelPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20241204153410_attractionInTrail")]
    partial class attractionInTrail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelPlanner.Domain.Models.Trails.AttractionInTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AttractionInTrails");
                });

            modelBuilder.Entity("TravelPlanner.Domain.Models.Trails.Trail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.GetAttractionCategoryDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GetAttractionCategoryDto");
                });
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetAddressDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GetAddressDto");
                });

            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetCountryDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GetCountryDto");
                });

            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetLocalityDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("GetLocalityDto");
                });

            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetProvinceDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelPlanner.Domain.Models.Trails.AttractionInTrail", b =>
                {
                    ...
                    b.HasOne("TravelPlanner.Domain.Models.Trails.Trail", "Trail")
                        .WithMany("Attractions")
            ...
            modelBuilder.Entity("TravelPlanner.Domain.Models.Trails.Trail", b =>
                {
                    ...
                    b.HasOne("TravelPlanner.Domain.Models.ApplicationUser", "CreatedBy")
                        .WithMany("Trails")
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.GetAttractionDto", b =>
                {
                    b.HasOne("TravelPlanner.Shared.DTOs.Attraction.Location.GetAddressDto", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId");

                    b.HasOne("TravelPlanner.Shared.DTOs.Attraction.GetAttractionCategoryDto", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId");
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetAddressDto", b =>
                {
                    b.HasOne("TravelPlanner.Shared.DTOs.Attraction.Location.GetLocalityDto", "Locality")
                        .WithMany()
                        .HasForeignKey("LocalityId");
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetLocalityDto", b =>
                {
                    b.HasOne("TravelPlanner.Shared.DTOs.Attraction.Location.GetProvinceDto", "Province")
                        .WithMany()
                        .HasForeignKey("ProvinceId");
            ...
            modelBuilder.Entity("TravelPlanner.Shared.DTOs.Attraction.Location.GetProvinceDto", b =>
                {
                    b.HasOne("TravelPlanner.Shared.DTOs.Attraction.Location.GetCountryDto", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId");
